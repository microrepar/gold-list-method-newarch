"""create tables gold-list-method

Revision ID: 25b6989e0e57
Revises: 
Create Date: 2023-12-15 13:46:48.648002
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['gold_list_method.user.id'], ),
    sa.PrimaryKeyConstraint('id'),
...
def downgrade() -> None:
    ...
    op.drop_table('user', schema='gold_list_method')
